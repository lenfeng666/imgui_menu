...
int APIENTRY WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
    ...
    g_fontChinese = io.Fonts->AddFontFromFileTTF("c:\\Windows\\Fonts\\msyh.ttc", 20.0f, nullptr, io.Fonts->GetGlyphRangesChineseFull());
    ...
    while (!done)
    {
        ...
        //     if (p_open)
        //     {
        //         ImGui::Begin("FY", &p_open, ImGuiWindowFlags_NoResize);
        //         ImGui::Button("Hello, world!");
        //         ImGui::Text("中文中文 chinese.");
        //         ImGui::SameLine();
        //         HelpMarker("hell");
        //         ImGui::End();
        //     }
